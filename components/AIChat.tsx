...
const AIChat: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: 'Welcome to Kulibre. How can I assist with your automation strategy? 🤖' }
  ]);
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="mb-4 w-[90vw] md:w-96 bg-black/80 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden shadow-2xl shadow-teal-500/20"
          >
            {/* Header */}
            <div className="bg-gradient-to-r from-slate-900/50 to-teal-900/50 p-4 flex justify-between items-center border-b border-white/10">
            ...
            <div className="p-3 border-t border-white/10 bg-black/40">
              <div className="flex gap-2">
                <input
                  ...
                  placeholder="Ask about accuracy, layers..."
